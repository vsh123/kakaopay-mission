...
insert into region(code,name) values('asdf','테스트시')
insert into region(code,name) values('ddd','11')

insert into region_support_information(region_code,target,usage,limit_support,limit_pay,rate_info,avg_rate,institute,mgmt,reception) values(1,'target','usage','limitpay','2000','3%',3.0,'institute','mgmt','reception')
