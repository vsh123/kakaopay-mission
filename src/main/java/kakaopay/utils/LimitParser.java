...
public class LimitParser {
    private static final String RECOMMEND_REGEX = "추천금액 이내";
    private static final String MILLION_REGEX = "[0-9]+백만원 이내";
    private static final String BILLION_REGEX = "[0-9]+억원 이내";
    ...
    public static Long parse(String limitSupport) {
        if (RECOMMEND_REGEX.matches(limitSupport)) {
            return 0L;
        }
